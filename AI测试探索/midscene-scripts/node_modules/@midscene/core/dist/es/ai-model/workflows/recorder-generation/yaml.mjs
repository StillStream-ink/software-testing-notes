...
import { callAI, callAIWithStringResponse } from "../../service-caller/index.mjs";
import { createEventCounts, createMessageContent, extractInputDescriptions, filterEventsByType, getScreenshotsForLLM, prepareEventSummary, prepareRecorderGenerationContext, processEventsForLLM, validateEvents } from "./common.mjs";
...
const generateRecorderYamlTest = async (input, modelConfig)=>{
    try {
        ...
        const response = await callAIWithStringResponse(prompt, createModelRuntime(modelConfig));
