...
const registerFileChooserAcceptParamSchema = z.object({
    files: z.union([
        z.string(),
        z.array(z.string())
...
const actionKeyboardPressParamSchema = z.object({
    locate: getMidsceneLocationSchema().describe('The optional element to click before pressing the key. Omit this when the key should operate on the currently focused element, especially when copying or cutting an existing text selection.').optional(),
