...
function removeReportArtifact(reportFilePath) {
    if (isDirectoryBasedReport(reportFilePath)) return void rmSync(dirname(reportFilePath), {
        recursive: true,
        force: true
    });
    ...
    mergeReports(reportFileName = 'AUTO', opts) {
        ...
        try {
            ...
            if (rmOriginalReports) {
                ...
                logMsg(`Removed ${removedReportCount}/${reportCountWithFilePath} original reports`);
            }
...
export { ReportMergingTool, collectDedupedExecutions, dedupeExecutionsKeepLatest, isDirectoryModeReport, removeReportArtifact, splitReportHtmlByExecution };
