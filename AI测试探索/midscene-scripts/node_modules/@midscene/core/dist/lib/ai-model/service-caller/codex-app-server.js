...
class CodexAppServerConnection {
    ...
    async runTurn({ messages, modelConfig, stream, onChunk, reasoningEnabled, abortSignal, imageDetail, onRecordEvent }) {
        ...
        try {
            ...
            while(!turnStatus){
                ...
                const belongsToCurrentTurn = params.threadId === threadId && (params.turnId === turnId || params.turn?.id === turnId);
                if (belongsToCurrentTurn) onRecordEvent?.({
                    type: 'chunk',
                    protocol: {
                        direction: 'server',
                        method,
