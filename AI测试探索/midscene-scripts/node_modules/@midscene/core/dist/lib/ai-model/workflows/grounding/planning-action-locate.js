...
const conversation_history_js_namespaceObject = require("../planning/conversation-history.js");
...
async function buildPlanningTapLocatorPlanOptions(locateRequest) {
    ...
    return {
        ...
        conversationHistory: new conversation_history_js_namespaceObject.ConversationHistory(),
