...
function createRecorderMarkdownReplayPrompt(input) {
    (0, external_common_js_namespaceObject.validateEvents)(input.events);
    const { summary: rawSummary, screenshotAssets: rawScreenshotAssets } = (0, external_common_js_namespaceObject.prepareRecorderGenerationContext)(input);
...
async function generateRecorderMarkdownReplay(input, modelConfig) {
    try {
