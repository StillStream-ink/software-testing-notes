...
const actionKeyboardPressParamSchema = external_zod_namespaceObject.z.object({
    locate: (0, external_common_js_namespaceObject.getMidsceneLocationSchema)().describe('The optional element to click before pressing the key. Omit this when the key should operate on the currently focused element, especially when copying or cutting an existing text selection.').optional(),
