...
const report_dump_compactor_js_namespaceObject = require("./dump/report-dump-compactor.js");
...
const warnReport = (0, logger_namespaceObject.getDebug)('report-generator', {
    console: true
});
...
class ReportGenerator {
    ...
    async finalize() {
        ...
        try {
            await (0, report_dump_compactor_js_namespaceObject.compactReportDumps)(this.reportPath);
        } catch (error) {
            warnReport(`Failed to compact report ${this.reportPath}; keeping the uncompressed report: ${String(error)}`);
        }
