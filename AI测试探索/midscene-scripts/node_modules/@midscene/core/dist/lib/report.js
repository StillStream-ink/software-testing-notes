...
__webpack_require__.d(__webpack_exports__, {
    ...
    removeReportArtifact: ()=>removeReportArtifact,
...
function removeReportArtifact(reportFilePath) {
    if (isDirectoryBasedReport(reportFilePath)) return void (0, external_node_fs_namespaceObject.rmSync)(external_node_path_namespaceObject.dirname(reportFilePath), {
        recursive: true,
        force: true
    });
    (0, external_node_fs_namespaceObject.unlinkSync)(reportFilePath);
}
    ...
    mergeReports(reportFileName = 'AUTO', opts) {
        ...
        try {
            ...
            if (rmOriginalReports) {
                ...
                for (const info of this.reportInfos)if (info.reportFilePath) {
                ...
                (0, utils_namespaceObject.logMsg)(`Removed ${removedReportCount}/${reportCountWithFilePath} original reports`);
            }
...
exports.removeReportArtifact = __webpack_exports__.removeReportArtifact;
