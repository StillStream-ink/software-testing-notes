...
class ScreenshotItem {
    static create(base64, capturedAt) {
        return new ScreenshotItem((0, utils_namespaceObject.uuid)(), base64, capturedAt, detectFormat(base64));
    }
    static fromFile(filePath, mimeType, capturedAt) {
        const item = new ScreenshotItem((0, utils_namespaceObject.uuid)(), null, capturedAt, 'image/jpeg' === mimeType ? 'jpeg' : 'png');
    ...
    constructor(id, base64, capturedAt, format){
