...
const search_area_js_namespaceObject = require("../ai-model/workflows/grounding/search-area.js");
...
function getDescribeDeepContextAreas(rect, screenSize) {
    return [
        {
            kind: 'focused',
            rect: (0, search_area_js_namespaceObject.expandSearchArea)(rect, screenSize)
        }
    ];
}
