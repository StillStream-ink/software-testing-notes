...
export { extractJSONFromCodeBlock, parseModelResponseJson, } from '../shared/json';
...
export declare function createChatClient({ modelConfig, executionId, recordEvent, }: {
...
export declare function parseAIObjectResponse<T>(response: Awaited<ReturnType<typeof callAI>>, modelRuntime: ModelRuntime, jsonParserSource?: JsonParserSource): AIObjectResponse<T>;
