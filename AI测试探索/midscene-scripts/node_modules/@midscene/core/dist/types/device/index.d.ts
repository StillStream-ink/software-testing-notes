...
export declare const registerFileChooserAcceptParamSchema: z.ZodObject<{
...
export declare const defineActionRegisterFileChooserAccept: (register: (files: string | string[]) => Promise<void>) => DeviceAction<RegisterFileChooserAcceptParam>;
