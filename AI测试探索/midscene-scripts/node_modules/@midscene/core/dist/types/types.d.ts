...
export interface InsightAPI<QueryOpt extends QueryOptions = QueryOptions, AssertOpt extends AssertOptions = AssertOptions> {
    aiQuery<ReturnType = any>(demand: ServiceExtractParam, options?: QueryOpt): Promise<ReturnType>;
    ...
    aiAssert(assertion: TUserPrompt, message?: string, options?: AssertOpt): Promise<AgentAssertResult | undefined>;
}
/**
 * planning
 *
