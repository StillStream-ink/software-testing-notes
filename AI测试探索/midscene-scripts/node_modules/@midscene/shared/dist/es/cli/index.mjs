...
import { createRecordCliCommand } from "./record-command.mjs";
...
export { CLIError, attachCliVerboseDumpListener, createRecordCliCommand, emitCliVerboseEvent, getCliVerboseContext, isCliVerboseEnabled, parseCliArgs, parseValue, removePrefix, reportCLIError, runToolsCLI, stripVerboseFlag, withCliVerboseContext };
