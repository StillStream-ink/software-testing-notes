...
const record_command_js_namespaceObject = require("../cli/record-command.js");
...
class BaseMidsceneTools {
    ...
    getCliToolDefinitions() {
        return [
            (0, record_command_js_namespaceObject.createRecordCliCommand)((args = {})=>this.ensureAgent(this.extractAgentInitParam(args)), this.getAgentInitArgSchema(), this.getAgentInitArgCliMetadata())
        ];
    }
    setAgent(agent) {
        this.agent = agent;
