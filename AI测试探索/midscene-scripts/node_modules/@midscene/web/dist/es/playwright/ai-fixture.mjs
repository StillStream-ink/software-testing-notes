import { resolveBrowserAgentRuntimeOptions } from "../common/browser-agent.mjs";
import { PlaywrightAgent, PlaywrightBrowserAgent } from "./index.mjs";
...
const PlaywrightAiFixture = (options)=>{
    const { forceSameTabNavigation = true, autoFollowNewPage = false, waitForNetworkIdleTimeout = DEFAULT_WAIT_FOR_NETWORK_IDLE_TIMEOUT, waitForNavigationTimeout = DEFAULT_WAIT_FOR_NAVIGATION_TIMEOUT, cache, ...sharedAgentOptions } = options ?? {};
    ...
    const createOrReuseAgentForPage = (page, testInfo, opts)=>{
        ...
        if (!idForPage) {
            ...
            const agent = autoFollowNewPage ? new PlaywrightBrowserAgent(page.context(), page, {
                ...commonAgentOpts,
