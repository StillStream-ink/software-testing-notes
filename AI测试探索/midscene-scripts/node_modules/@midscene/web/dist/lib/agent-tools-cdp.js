...
class WebCdpMidsceneTools extends base_tools_namespaceObject.BaseMidsceneTools {
    ...
    async ensureAgent(initArgs) {
        ...
        if (initArgs?.extraHTTPHeaders) await page.setExtraHTTPHeaders(initArgs.extraHTTPHeaders);
        if (navigateToUrl) await page.goto(navigateToUrl, {
            timeout: 30000,
    ...
    constructor(cdpEndpoint){
        super(), _define_property(this, "cdpEndpoint", void 0), _define_property(this, "activeBrowser", null), _define_property(this, "lastInitArgsSignature", void 0), _define_property(this, "initArgSpec", {
            namespace: 'web',
            shape: external_agent_init_args_js_namespaceObject.webCdpAgentInitArgShape,
            cli: {
                preferBareKeys: true
            },
            adapt: external_agent_init_args_js_namespaceObject.adaptWebCdpAgentInitArgs
        });
