...
const debug = (0, logger_namespaceObject.getDebug)('web:bridge:io-server');
    ...
    async listen(opts = {}) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            this.io.use((socket, next)=>{
                ...
                if (false === socket.handshake.url.includes(external_common_js_namespaceObject.BridgeSignalKill) && this.socket?.connected) return next(new Error('server already connected by another client'));
                next();
            });
            this.io.on('connection', (socket)=>{
                ...
                try {
                    ...
                    (0, shared_utils_namespaceObject.logMsg)(`Bridge connected, cli-side version v1.10.12, browser-side version v${clientVersion}`);
