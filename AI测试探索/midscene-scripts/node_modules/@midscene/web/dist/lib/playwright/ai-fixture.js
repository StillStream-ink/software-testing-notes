...
const browser_agent_js_namespaceObject = require("../common/browser-agent.js");
...
const PlaywrightAiFixture = (options)=>{
    const { forceSameTabNavigation = true, autoFollowNewPage = false, waitForNetworkIdleTimeout = constants_namespaceObject.DEFAULT_WAIT_FOR_NETWORK_IDLE_TIMEOUT, waitForNavigationTimeout = constants_namespaceObject.DEFAULT_WAIT_FOR_NAVIGATION_TIMEOUT, cache, ...sharedAgentOptions } = options ?? {};
    ...
    const createOrReuseAgentForPage = (page, testInfo, opts)=>{
        ...
        if (!idForPage) {
            ...
            if (autoFollowNewPage && true === forceSameTabNavigation) throw new Error('[midscene] autoFollowNewPage cannot be used with forceSameTabNavigation: true.');
            const runtimeOptions = (0, browser_agent_js_namespaceObject.resolveBrowserAgentRuntimeOptions)({
                agentName: 'PlaywrightAiFixture',
                pageScope: autoFollowNewPage ? 'browser' : 'page',
                forceSameTabNavigation: autoFollowNewPage ? void 0 : forceSameTabNavigation,
                autoFollowNewPage
            });
            ...
            const agent = autoFollowNewPage ? new external_index_js_namespaceObject.PlaywrightBrowserAgent(page.context(), page, {
                ...commonAgentOpts,
                autoFollowNewPage: runtimeOptions.autoFollowNewPage
            }) : new external_index_js_namespaceObject.PlaywrightAgent(page, {
                ...commonAgentOpts,
