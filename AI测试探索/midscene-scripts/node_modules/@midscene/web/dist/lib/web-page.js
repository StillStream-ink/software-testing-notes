...
const scheduleWebVisualUpdate = (page, force = false)=>{
    if (page.schedulePendingVisualUpdate) {
        if (force) page.schedulePendingVisualUpdate(true);
        else page.schedulePendingVisualUpdate();
        return;
    }
    const pendingRefresh = force ? page.flushPendingVisualUpdate?.(true) : page.flushPendingVisualUpdate?.();
    ...
    return {
        ...
        keyboard: {
            typeText: async (value, opts)=>{
                ...
                const keyboardTypeOptions = opts?.keyboardTypeDelay === void 0 ? void 0 : {
