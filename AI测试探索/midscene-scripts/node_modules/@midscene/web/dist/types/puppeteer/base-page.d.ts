...
import type { AbstractInterface, DeviceFrameSource, MjpegStreamHandle, MjpegStreamOptions } from '@midscene/core/device';
...
export declare class Page<AgentType extends 'puppeteer' | 'playwright', InterfaceType extends PuppeteerPage | PlaywrightPage> implements AbstractInterface {
    ...
    private visualUpdateForceQueued;
     ...
     */
    openFrameSource(): Promise<DeviceFrameSource>;
    url(): Promise<string>;
    describe(): string;
    get mouse(): {
